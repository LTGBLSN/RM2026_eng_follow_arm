...
uint8_t servo_rx_buf[64]; // ½ÓÊÕ»º³åÇø

int16_t servo00_angle ;
int16_t servo01_angle ;
int16_t servo02_angle ;
int16_t servo03_angle ;
int16_t servo04_angle ;
