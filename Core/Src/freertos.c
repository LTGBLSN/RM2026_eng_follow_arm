...
void servo_uart_sent(void const * argument);
...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(aim_uart_task, servo_uart_sent, osPriorityIdle, 0, 256);
...
/* USER CODE BEGIN Header_servo_uart_sent */
/**
* @brief Function implementing the aim_uart_task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_servo_uart_sent */
__weak void servo_uart_sent(void const * argument)
{
  /* USER CODE BEGIN servo_uart_sent */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END servo_uart_sent */
}
